...
> Note: The installation package is available in the [Releases](https://github.com/runlingli/Scribe_desktop_video_player/releases) section. Due to file size limitations, the package is not included in the repository.
